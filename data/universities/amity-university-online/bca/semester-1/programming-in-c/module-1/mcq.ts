...
export const mcq: MCQ[] = [
  ...
  },
  {
    ...
    "options": [
      "Physical memory stored in registers",
      "Space on the hard disk used as RAM",
      "Permanent memory",
      "Reserved space in ROM"
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      "Erased and Electronically Programmed ROM",
      "None of the above"
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      "High Text Telecommunication Protocol",
  ...
  },
  {
    ...
    "options": [
      ...
      "Increase processing speed by storing frequently used data",
      "Backup memory",
      "Replace RAM"
    ],
